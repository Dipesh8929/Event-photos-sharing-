...
//   const onCityChanged = (e) => setCity(e.target.value);
  ...
  // this is validation of pincode x

//   async function fetchDataAndPrint() {
//     try {
//       const data = await fetchData();
  
//       // Access the PostOffice array and check if the name or district is 'Aligarh'
//       for (let i = 0; i < data[0].PostOffice.length; i++) {
//         if (data[0].PostOffice[i].Name === 'Aligarh' || data[0].PostOffice[i].District === 'Aligarh') {
//           // Resolve with 'Yes' if found
//           return Promise.resolve('Yes');
//         }
//       }
  
//       // If no match found, resolve with 'NO'
...
//   // Call the function to fetch data and print
//   fetchDataAndPrint()
